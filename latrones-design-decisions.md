...
- **Blockade / immobilisation — [A], Strong, and foregrounded.** Plato (*Republic* 487b–c) makes being *cornered and unable to move* the defining image; Polybius (*Histories* 1.84.7–8) likens Hamilcar's hemming-in of an enemy *without a battle* to a good *petteia* player (widely misquoted as "Scipio"); Aristotle (*Politics* 1253a) names the isolated, *azux* piece. To leave the opponent with no legal move is a win. We restore this as a *primary* path, against reconstructions that treat reduction-to-one as the win and immobilisation as a footnote.
